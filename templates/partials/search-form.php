<div class="search-form__wrapper">
    <form class="search-form" role="search" method="get" action="<?php echo home_url('/'); ?>">
        ...
        <div class="search-form__submit-wrapper">
            <button class="<?php echo apply_filters('govuk_theme_class', 'govuk-button search-form__button') ?>" data-module="govuk-button" aria-labelledby="search-form__button-label">
                <span id="search-form__button-label" hidden=""><?php _e('Search', 'govuk-theme'); ?></span>
